...
public class LegacyNewRouteTest {

	private LegacyNewRoute pageChooser;
	
	@Before public void
	init() {
		pageChooser = new LegacyNewRoute();
	}
	...
	@Test public void
	returnsNewPage() {
		assertTrue( pageChooser.buildsPage(null) instanceof LegacyNewPage );
	}
