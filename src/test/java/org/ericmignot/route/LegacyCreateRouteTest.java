...
public class LegacyCreateRouteTest {

	private LegacyCreateRoute pageChooser;
	
	@Before public void
	init() {
		pageChooser = new LegacyCreateRoute();
	}
	...
	@Test public void
	returnsCorrectPage() {
		LegacySavePage page = (LegacySavePage) pageChooser.buildsPage( request("/specs/create", "specXName=mytestcreation") );
